...
public class EmailResourceIntTest {
    ...
    private static final TypeEmail DEFAULT_TYPE = TypeEmail.TO;
    private static final TypeEmail UPDATED_TYPE = TypeEmail.FROM;
    ...
    public void setup() {
        ...
        final EmailResource emailResource = new EmailResource(emailRepository, emailSearchRepository);
    ...
    public void createEmail() throws Exception {
        ...
        assertThat(emailEs).isEqualToIgnoringGivenFields(testEmail);
    }
